...
clean: clean-tests clean-toplevel clean-utilities clean-mods clean-symlinks clean-genmods
...
# These are generated by the Intel compiler
clean-genmods:
	rm -f mod/*__genmod.mod mod/*__genmod.f90
