...
NACTIVE_AEROSOL = YGFL%NACTAERO
IF (YGFL%NACTAERO == 0 .AND. YRERAD%NAERMACC == 1) NACTIVE_AEROSOL = YRERAD%NMCVAR
IRADLP = YRERAD%NRADLP
IF (NACTIVE_AEROSOL >= 12 .AND. YRECLDP%NAERCLD > 0 ) IRADLP=3 
