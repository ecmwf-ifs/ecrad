...
def get_half_level_fluxes(ecrad_output, flux_names):
    try:
...
class ecRADOutputError:
    ...
    def _verify_output(self):
        fluxes = get_half_level_fluxes(self.output.data_set, self.output.flux_names)
        ref_fluxes = get_half_level_fluxes(self.ref.data_set, self.output.flux_names)
