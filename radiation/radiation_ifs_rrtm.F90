...
!    end if
    ...
    if (thermodynamics%rrtm_pass_temppres_fl) then
      pressure_fl   (istartcol:iendcol,:) = thermodynamics%pressure_fl   (istartcol:iendcol,:)
      temperature_fl(istartcol:iendcol,:) = thermodynamics%temperature_fl(istartcol:iendcol,:)
    else
