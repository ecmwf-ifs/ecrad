...
!      IG=1
        ...
        P_TAU(NGS13+IG,JLON,JLAY) = P_COLCO2(JLON,JLAY) *&
         & (P_FAC00(JLON,JLAY) * ABSA(IG,IND0  ) +&
         & P_FAC10(JLON,JLAY) * ABSA(IG,IND0+1) +&
         & P_FAC01(JLON,JLAY) * ABSA(IG,IND1  ) +&
         & P_FAC11(JLON,JLAY) * ABSA(IG,IND1+1)) &
         & + ZTAUSELF + ZTAUFOR &
         & + P_TAUAERL(JLON,JLAY,14)  
        PFRAC(NGS13+IG,JLON,JLAY) = FRACREFA(IG)
      ENDDO
!-- jjm20110728
!-- DS_990714  
    ENDIF
...
!      IG=1
        P_TAU(NGS13+IG,JLON,JLAY) = P_COLCO2(JLON,JLAY) *&
         ...
         & + P_TAUAERL(JLON,JLAY,14)  
        PFRAC(NGS13+IG,JLON,JLAY) = FRACREFB(IG)
      ENDDO
!-- jjm20110728
!-- DS_990714  
    ENDIF
