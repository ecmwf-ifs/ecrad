  ...
  DO JP = 1,13
    ...
    DO IGC = 1,NGC(2)
      ...
      DO IPR = 1, NGN(NGS(1)+IGC)
        ...
        Z_SUMK = Z_SUMK + KAO(IPRSM,JT,JP)*RWGT(IPRSM+16)
      ENDDO
  ...
  DO JP = 13,59
    ...
    DO IGC = 1,NGC(2)
      ...
      DO IPR = 1, NGN(NGS(1)+IGC)
        ...
        Z_SUMK = Z_SUMK + KBO(IPRSM,JT,JP)*RWGT(IPRSM+16)
      ENDDO
!               KBC(JT,JP,IGC) = SUMK
      KB(IGC,JT,JP) = Z_SUMK
    ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(2)
    ...
    DO IPR = 1, NGN(NGS(1)+IGC)
      ...
      Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+16)
    ENDDO
...
DO JT = 1,4
   ...
   DO IGC = 1,NGC(2)
      Z_SUMK = 0.0_JPRB
        DO IPR = 1, NGN(NGS(1)+IGC)
           IPRSM = IPRSM + 1
           Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+16)
        ENDDO
