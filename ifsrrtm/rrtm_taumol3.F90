!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL3(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,&
...
REAL(KIND=JPRB)   ,INTENT(IN)   :: PRAT_H2OCO2(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: PRAT_H2OCO2_1(KIDIA:KFDIA,YDDIMV%NFLEVG)
...
REAL(KIND=JPRB) :: ZADJFAC,ZADJCOLN2O(KIDIA:KFDIA,YDDIMV%NFLEVG),ZRATN2O,Z_CHI_N2O
