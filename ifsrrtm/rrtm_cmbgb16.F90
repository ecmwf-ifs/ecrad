    ...
    DO JP = 1,13
      ...
      DO IGC = 1,NGC(16)
        ...
        DO IPR = 1, NGN(NGS(15)+IGC)
          ...
          Z_SUMK = Z_SUMK + KAO(IPRSM,JN,JT,JP)*RWGT(IPRSM+240)
        ENDDO
...
DO JT = 1,5
   DO JP = 13,59
      ...
      DO IGC = 1,NGC(16)
         ...
         DO IPR = 1, NGN(NGS(15)+IGC)
            IPRSM = IPRSM + 1
            Z_SUMK = Z_SUMK + KBO(IPRSM,JT,JP)*RWGT(IPRSM+240)
         ENDDO
         KB(IGC,JT,JP) = Z_SUMK
      ENDDO
   ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(16)
    ...
    DO IPR = 1, NGN(NGS(15)+IGC)
      ...
      Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+240)
    ENDDO
...
DO JT = 1,4
   ...
   DO IGC = 1,NGC(16)
      ...
      DO IPR = 1, NGN(NGS(15)+IGC)
         IPRSM = IPRSM + 1
         Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+240)
      ENDDO
