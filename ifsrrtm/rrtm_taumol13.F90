!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL13(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,&
...
REAL(KIND=JPRB)   ,INTENT(IN)   :: PRAT_H2ON2O(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: PRAT_H2ON2O_1(KIDIA:KFDIA,YDDIMV%NFLEVG)
...
REAL(KIND=JPRB) :: Z_SPECCOMB(YDDIMV%NFLEVG),Z_SPECCOMB1(YDDIMV%NFLEVG), Z_SPECCOMB_PLANCK(YDDIMV%NFLEVG),&
                   & Z_SPECCOMB_MCO2(YDDIMV%NFLEVG), Z_SPECCOMB_MCO(YDDIMV%NFLEVG)
...
REAL(KIND=JPRB) :: ZCHI_CO2, ZRATCO2, ZADJFAC, ZADJCOLCO2(KIDIA:KFDIA,YDDIMV%NFLEVG)
...
REAL(KIND=JPRB)   :: Z_COLCO(KIDIA:KFDIA,YDDIMV%NFLEVG) !left =0 for now,not passed from rrtm_gasbas1a
