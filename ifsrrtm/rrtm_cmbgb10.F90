  ...
  DO JP = 1,13
    ...
    DO IGC = 1,NGC(10)
      ...
      DO IPR = 1, NGN(NGS(9)+IGC)
        ...
        Z_SUMK = Z_SUMK + KAO(IPRSM,JT,JP)*RWGT(IPRSM+144)
      ENDDO
  ...
  DO JP = 13,59
    ...
    DO IGC = 1,NGC(10)
      ...
      DO IPR = 1, NGN(NGS(9)+IGC)
        ...
        Z_SUMK = Z_SUMK + KBO(IPRSM,JT,JP)*RWGT(IPRSM+144)
      ENDDO
...
ENDDO
  ...
  DO JT = 1,10
         ...
         DO IGC = 1,NGC(10)
            ...
            DO IPR = 1, NGN(NGS(9)+IGC)
               IPRSM = IPRSM + 1
               Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+144)
            ENDDO
      ...
      DO JT = 1,4
         ...
         DO IGC = 1,NGC(10)
            ...
            DO IPR = 1, NGN(NGS(9)+IGC)
               IPRSM = IPRSM + 1
               Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+144)
            ENDDO
