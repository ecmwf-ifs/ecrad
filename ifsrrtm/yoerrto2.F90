...
REAL(KIND=JPRB) :: KAO(NO2,5,13)
REAL(KIND=JPRB) :: KBO(NO2,5,13:59)
REAL(KIND=JPRD) :: KAO_D(NO2,5,13)
REAL(KIND=JPRD) :: KBO_D(NO2,5,13:59)
REAL(KIND=JPRB) :: SELFREFO(NO2,10) , FORREFO(NO2,4)
