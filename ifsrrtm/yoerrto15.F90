...
REAL(KIND=JPRB) :: KAO(NO15,9,5,13)
REAL(KIND=JPRD) :: KAO_D(NO15,9,5,13)
REAL(KIND=JPRB) :: SELFREFO(NO15,10)
REAL(KIND=JPRB) :: FORREFO(NO15,4)
REAL(KIND=JPRB) :: KAO_MN2(NO15,9,19)
!     -----------------------------------------------------------------
