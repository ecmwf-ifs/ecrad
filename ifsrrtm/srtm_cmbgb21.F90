    ...
    DO JP = 1,13
      ...
      DO IGC = 1,NGC(6)
        ...
        DO IPR = 1, NGN(NGS(5)+IGC)
          IPRSM = IPRSM + 1
          ZSUMK = ZSUMK + KA(IPRSM,JN,JT,JP)*RWGT(IPRSM+80)
        ENDDO
  ...
  DO JT = 1,5
    DO JP = 13,59
      ...
      DO IGC = 1,NGC(6)
        ...
        DO IPR = 1, NGN(NGS(5)+IGC)
          IPRSM = IPRSM + 1
          ZSUMK = ZSUMK + KB(IPRSM,JN,JT,JP)*RWGT(IPRSM+80)
        ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(6)
    ...
    DO IPR = 1, NGN(NGS(5)+IGC)
      IPRSM = IPRSM + 1
      ZSUMK = ZSUMK + SELFREF(IPRSM,JT)*RWGT(IPRSM+80)
    ENDDO
...
DO JT = 1,4
  ...
  DO IGC = 1,NGC(6)
    ...
    DO IPR = 1, NGN(NGS(5)+IGC)
      IPRSM = IPRSM + 1
      ZSUMK = ZSUMK + FORREF(IPRSM,JT)*RWGT(IPRSM+80)
    ENDDO
