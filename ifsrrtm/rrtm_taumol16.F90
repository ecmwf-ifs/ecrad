!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL16(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,&
...
REAL(KIND=JPRB)   ,INTENT(IN)   :: P_RAT_H2OCH4(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: P_RAT_H2OCH4_1(KIDIA:KFDIA,YDDIMV%NFLEVG)
