...
REAL(KIND=JPRB) :: KA(NG9,9,5,13) ,ABSA(NG9,585)
REAL(KIND=JPRB) :: KB(NG9,5,13:59) ,ABSB(NG9,235)
REAL(KIND=JPRB) :: KA_MN2O(NG9,9,19)
REAL(KIND=JPRB) :: KB_MN2O(NG9,19)
REAL(KIND=JPRB) :: SELFREF(NG9,10)
REAL(KIND=JPRB) :: FORREF(NG9,4)
