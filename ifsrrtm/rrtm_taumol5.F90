!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL5(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,P_WX,&
...
REAL(KIND=JPRB) :: Z_SPECCOMB(YDDIMV%NFLEVG),Z_SPECCOMB1(YDDIMV%NFLEVG),&
& Z_SPECCOMB_MO3(YDDIMV%NFLEVG), Z_SPECCOMB_PLANCK(YDDIMV%NFLEVG)
