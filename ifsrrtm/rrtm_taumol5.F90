...
!CDIR UNROLL=NG5
      DO IG = 1, NG5
         ...
         ZO3M1 = KA_MO3(IG,JMO3,INDM(JLAY)) + Z_FMO3 * &
            &     (KA_MO3(IG,JMO3+1,INDM(JLAY)) - KA_MO3(IG,JMO3,INDM(JLAY)))
         ZO3M2 = KA_MO3(IG,JMO3,INDM(JLAY)+1) + Z_FMO3 * &
            &     (KA_MO3(IG,JMO3+1,INDM(JLAY)+1) - KA_MO3(IG,JMO3,INDM(JLAY)+1))
        ...
        P_TAU(NGS4+IG,JLON,JLAY) = ZTAU_MAJOR + ZTAU_MAJOR1 &
         & + ZTAUSELF + ZTAUFOR &
         & + ZABSO3*P_COLO3(JLON,JLAY) &
         & + P_WX(JLON,1,JLAY) * CCL4(IG)&
         & + P_TAUAERL(JLON,JLAY,5)  
        PFRAC(NGS4+IG,JLON,JLAY) = FRACREFA(IG,JPL) + Z_FPL *&
...
!CDIR UNROLL=NG5
      DO IG = 1, NG5
!-- DS_000515
        P_TAU(NGS4+IG,JLON,JLAY) = Z_SPECCOMB(JLAY) *   &
         ...
         & P_WX(JLON,1,JLAY) * CCL4(IG)+&
         & P_TAUAERL(JLON,JLAY,5)  
        PFRAC(NGS4+IG,JLON,JLAY) = FRACREFB(IG,JPL) + Z_FPL *&
