!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL4(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,&
...
REAL(KIND=JPRB)   ,INTENT(IN)   :: P_RAT_H2OCO2(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: P_RAT_H2OCO2_1(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: P_RAT_O3CO2(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: P_RAT_O3CO2_1(KIDIA:KFDIA,YDDIMV%NFLEVG)
...
INTEGER(KIND=JPIM) :: IND0(YDDIMV%NFLEVG),IND1(YDDIMV%NFLEVG),INDS(YDDIMV%NFLEVG),INDF(YDDIMV%NFLEVG)
