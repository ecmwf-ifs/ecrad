...
REAL(KIND=JPRB) :: KA(NG1,5,13)   , ABSA(NG1,65)
REAL(KIND=JPRB) :: KB(NG1,5,13:59), ABSB(NG1,235)
REAL(KIND=JPRB) :: KA_MN2(NG1,19) , KB_MN2(NG1,19)
REAL(KIND=JPRB) :: SELFREF(NG1,10), FORREF(NG1,4)
