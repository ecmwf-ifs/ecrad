...
!-- DS_000515  
     ...
     &           FORREF(IG,INDF(JLAY))))  
        ZTAUO2 = ZSCALEO2*(KA_MO2(IG,INDM(JLAY)) +   &
     &           P_MINORFRAC(JLON,JLAY) * &
     &           (KA_MO2(IG,INDM(JLAY)+1) - KA_MO2(IG,INDM(JLAY)))) 

        P_TAU(NGS10+IG,JLON,JLAY) = P_COLH2O(JLON,JLAY) *&
        ...
        PFRAC(NGS10+IG,JLON,JLAY) = FRACREFA(IG)
      ENDDO
    ENDIF
...
!-- JJM_000517
     ...
     &           (FORREF(IG,INDF(JLAY)+1) - FORREF(IG,INDF(JLAY)))) 
        ...
        ZTAUO2 = ZSCALEO2*(KB_MO2(IG,INDM(JLAY)) +  &
     &           P_MINORFRAC(JLON,JLAY) * &
     &           (KB_MO2(IG,INDM(JLAY)+1) - KB_MO2(IG,INDM(JLAY))))
        ...
        PFRAC(NGS10+IG,JLON,JLAY) = FRACREFB(IG)
      ENDDO
    ENDIF
  ENDDO
ENDDO
