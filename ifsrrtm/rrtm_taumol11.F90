!******************************************************************************
SUBROUTINE RRTM_TAUMOL11(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,&
...
INTEGER(KIND=JPIM) :: INDS(YDDIMV%NFLEVG),INDF(YDDIMV%NFLEVG),INDM(YDDIMV%NFLEVG)
