...
!CDIR UNROLL=NG21
        DO IG = 1 , NG21
          P_TAUG(IG,IPLON,I_LAY) = Z_SPECCOMB * &
           !    & (Z_FAC000 * ABSB(IG,IND0) + &
           !    & Z_FAC100 * ABSB(IG,IND0+1) + &
           !    & Z_FAC010 * ABSB(IG,IND0+5) + &
           !    & Z_FAC110 * ABSB(IG,IND0+6) + &
           !    & Z_FAC001 * ABSB(IG,IND1) + &
           !    & Z_FAC101 * ABSB(IG,IND1+1) + &
           !    & Z_FAC011 * ABSB(IG,IND1+5) + &
           !    & Z_FAC111 * ABSB(IG,IND1+6)) + &
           & (&
