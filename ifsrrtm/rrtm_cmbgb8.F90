  ...
  DO JP = 1,13
    ...
    DO IGC = 1,NGC(8)
      ...
      DO IPR = 1, NGN(NGS(7)+IGC)
        IPRSM = IPRSM + 1
        Z_SUMK = Z_SUMK + KAO(IPRSM,JT,JP)*RWGT(IPRSM+112)
      ENDDO
      KA(IGC,JT,JP) = Z_SUMK
    ENDDO
  ENDDO
...
DO JT = 1,5
  DO JP = 13,59
    ...
    DO IGC = 1,NGC(8)
      ...
      DO IPR = 1, NGN(NGS(7)+IGC)
        IPRSM = IPRSM + 1
        Z_SUMK = Z_SUMK + KBO(IPRSM,JT,JP)*RWGT(IPRSM+112)
      ENDDO
      KB(IGC,JT,JP) = Z_SUMK
    ENDDO
  ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(8)
    ...
    DO IPR = 1, NGN(NGS(7)+IGC)
      IPRSM = IPRSM + 1
      Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+112)
    ENDDO
...
DO JT = 1,4
   ...
   DO IGC = 1,NGC(8)
      ...
      DO IPR = 1, NGN(NGS(7)+IGC)
         IPRSM = IPRSM + 1
         Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+112)
      ENDDO
...
DO IGC = 1,NGC(8)
  ...
  DO IPR = 1, NGN(NGS(7)+IGC)
    IPRSM = IPRSM + 1
    Z_SUMK1= Z_SUMK1+ KAO_MCO2(IPRSM,JT)*RWGT(IPRSM+112)
    Z_SUMK2= Z_SUMK2+ KBO_MCO2(IPRSM,JT)*RWGT(IPRSM+112)
    Z_SUMK3= Z_SUMK3+ KAO_MO3(IPRSM,JT)*RWGT(IPRSM+112)
    Z_SUMK4= Z_SUMK4+ KAO_MN2O(IPRSM,JT)*RWGT(IPRSM+112)
    Z_SUMK5= Z_SUMK5+ KBO_MN2O(IPRSM,JT)*RWGT(IPRSM+112)
  ENDDO
  KA_MCO2(IGC,JT) = Z_SUMK1
  KB_MCO2(IGC,JT) = Z_SUMK2
  KA_MO3(IGC,JT) = Z_SUMK3
  KA_MN2O(IGC,JT) = Z_SUMK4
  KB_MN2O(IGC,JT) = Z_SUMK5
ENDDO
ENDDO
