...
!-- DS_000515  
         ...
         P_TAU(NGS1+IG,JLON,JLAY) = ZCORRADJ * (P_COLH2O(JLON,JLAY) * &
        ...
        PFRAC(NGS1+IG,JLON,JLAY) = FRACREFA(IG) 
...
!-- JJM_000517
         ZTAUFOR = P_FORFAC(JLON,JLAY) * (FORREF(IG,INDF(JLAY)) + &
                &  P_FORFRAC(JLON,JLAY) * (FORREF(IG,INDF(JLAY)+1) - FORREF(IG,INDF(JLAY)))) 
         P_TAU(NGS1+IG,JLON,JLAY) = P_COLH2O(JLON,JLAY) * &
       ...
       PFRAC(NGS1+IG,JLON,JLAY) = FRACREFB(IG)
