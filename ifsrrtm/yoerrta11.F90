...
REAL(KIND=JPRB) :: KA(NG11,5,13)   , ABSA(NG11,65)
REAL(KIND=JPRB) :: KB(NG11,5,13:59), ABSB(NG11,235)
REAL(KIND=JPRB) :: KA_MO2(NG11,19)
REAL(KIND=JPRB) :: KB_MO2(NG11,19)
REAL(KIND=JPRB) :: SELFREF(NG11,10)
REAL(KIND=JPRB) :: FORREF(NG11,4)
