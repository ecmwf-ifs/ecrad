...
REAL(KIND=JPRB) :: KA(NG8,5,13)    ,ABSA(NG8,65)
REAL(KIND=JPRB) :: KB(NG8,5,13:59) ,ABSB(NG8,235)
REAL(KIND=JPRB) :: KA_MCO2(NG8,19)
REAL(KIND=JPRB) :: KA_MN2O(NG8,19)
REAL(KIND=JPRB) :: KA_MO3(NG8,19)
REAL(KIND=JPRB) :: KB_MCO2(NG8,19)
REAL(KIND=JPRB) :: KB_MN2O(NG8,19)
REAL(KIND=JPRB) :: SELFREF(NG8,10)
REAL(KIND=JPRB) :: FORREF(NG8,4)
