...
CALL RRTM_TAUMOL8  (KIDIA,KFDIA,KLEV,ZTAU,PWX,&
 ...
 & PMINORFRAC,KINDMINOR,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
CALL RRTM_TAUMOL9  (KIDIA,KFDIA,KLEV,ZTAU,&
 ...
 & PRAT_H2OCH4,PRAT_H2OCH4_1,PMINORFRAC,KINDMINOR,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
CALL RRTM_TAUMOL10 (KIDIA,KFDIA,KLEV,ZTAU,&
 & PTAUAERL,PFAC00,PFAC01,PFAC10,PFAC11,PFORFAC,PFORFRAC,KINDFOR,KJP,KJT,KJT1,&
 & PCOLH2O,KLAYTROP,PSELFFAC,PSELFFRAC,KINDSELF,PFRAC,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
...
CALL RRTM_TAUMOL12 (KIDIA,KFDIA,KLEV,ZTAU,&
 ...
 & PRAT_H2OCO2, PRAT_H2OCO2_1,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
CALL RRTM_TAUMOL13 (KIDIA,KFDIA,KLEV,ZTAU,&
 ...
 & PRAT_H2ON2O, PRAT_H2ON2O_1,PMINORFRAC,KINDMINOR,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
CALL RRTM_TAUMOL14 (KIDIA,KFDIA,KLEV,ZTAU,&
 & PTAUAERL,PFAC00,PFAC01,PFAC10,PFAC11,PFORFAC,PFORFRAC,KINDFOR,KJP,KJT,KJT1,&
 & PCOLCO2,KLAYTROP,PSELFFAC,PSELFFRAC,KINDSELF,PFRAC,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
...
CALL RRTM_TAUMOL16 (KIDIA,KFDIA,KLEV,ZTAU,&
 ...
 & PRAT_H2OCH4,PRAT_H2OCH4_1,laytrop_min=laytrop_min,laytrop_max=laytrop_max)
