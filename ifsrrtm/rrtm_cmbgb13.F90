    ...
    DO JP = 1,13
      ...
      DO IGC = 1,NGC(13)
        ...
        DO IPR = 1, NGN(NGS(12)+IGC)
          ...
          Z_SUMK = Z_SUMK + KAO(IPRSM,JN,JT,JP)*RWGT(IPRSM+192)
        ENDDO
   ...
   DO JT = 1,19
      ...
      DO IGC = 1,NGC(13)
        ...
        Z_SUMK2 = 0.0_JPRB
         DO IPR = 1, NGN(NGS(12)+IGC)
            IPRSM = IPRSM + 1
            Z_SUMK1 = Z_SUMK1 + KAO_MCO2(IPRSM,JN,JT)*RWGT(IPRSM+192)
            Z_SUMK2 = Z_SUMK2 + KAO_MCO(IPRSM,JN,JT)*RWGT(IPRSM+192)
         ENDDO
         KA_MCO2(IGC,JN,JT) = Z_SUMK1
         KA_MCO(IGC,JN,JT) = Z_SUMK2
      ENDDO
   ENDDO
ENDDO
...
DO JT = 1,19
   ...
   DO IGC = 1,NGC(13)
      ...
      DO IPR = 1, NGN(NGS(12)+IGC)
         IPRSM = IPRSM + 1
         Z_SUMK = Z_SUMK + KBO_MO3(IPRSM,JT)*RWGT(IPRSM+192)
      ENDDO
      KB_MO3(IGC,JT) = Z_SUMK
   ENDDO
ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(13)
    ...
    DO IPR = 1, NGN(NGS(12)+IGC)
      ...
      Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+192)
    ENDDO
...
DO JT = 1,4
   ...
   DO IGC = 1,NGC(13)
      ...
      DO IPR = 1, NGN(NGS(12)+IGC)
         IPRSM = IPRSM + 1
         Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+192)
      ENDDO
