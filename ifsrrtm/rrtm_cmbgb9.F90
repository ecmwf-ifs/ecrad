    ...
    DO JP = 1,13
      ...
      DO IGC = 1,NGC(9)
        ...
        DO IPR = 1, NGN(NGS(8)+IGC)
          ...
          Z_SUMK = Z_SUMK + KAO(IPRSM,JN,JT,JP)*RWGT(IPRSM+128)
        ENDDO
  ...
  DO JP = 13,59
    ...
    DO IGC = 1,NGC(9)
      ...
      DO IPR = 1, NGN(NGS(8)+IGC)
        ...
        Z_SUMK = Z_SUMK + KBO(IPRSM,JT,JP)*RWGT(IPRSM+128)
      ENDDO
   ...
   DO JN = 1,9
         DO JT = 1,19
            ...
            DO IGC = 1,NGC(9)
              Z_SUMK = 0.0_JPRB
               DO IPR = 1, NGN(NGS(8)+IGC)
                  IPRSM = IPRSM + 1
                   Z_SUMK = Z_SUMK + KAO_MN2O(IPRSM,JN,JT)*RWGT(IPRSM+128)
               ENDDO
      ...
      DO JT = 1,19
         ...
         DO IGC = 1,NGC(9)
            ...
            DO IPR = 1, NGN(NGS(8)+IGC)
               IPRSM = IPRSM + 1
               Z_SUMK = Z_SUMK + KBO_MN2O(IPRSM,JT)*RWGT(IPRSM+128)
            ENDDO
            KB_MN2O(IGC,JT) = Z_SUMK
         ENDDO
      ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(9)
    ...
    DO IPR = 1, NGN(NGS(8)+IGC)
      ...
      Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+128)
    ENDDO
...
ENDDO
   ...
   DO JT = 1,4
         ...
         DO IGC = 1,NGC(9)
            ...
            DO IPR = 1, NGN(NGS(8)+IGC)
               IPRSM = IPRSM + 1
               Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+128)
            ENDDO
