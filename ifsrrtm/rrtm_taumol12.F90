...
!-- DS_000515 
        ...
        P_TAU(NGS11+IG,JLON,JLAY) = ZTAU_MAJOR + ZTAU_MAJOR1 &
         & + ZTAUSELF + ZTAUFOR &
         & + P_TAUAERL(JLON,JLAY,12)  
        PFRAC(NGS11+IG,JLON,JLAY) = FRACREFA(IG,JPL) + Z_FPL *&
...
!CDIR UNROLL=NG12
      DO IG = 1, NG12
!-- JJM_000517
        P_TAU(NGS11+IG,JLON,JLAY) = P_TAUAERL(JLON,JLAY,12)
        PFRAC(NGS11+IG,JLON,JLAY) = 0.0_JPRB
      ENDDO
    ENDIF
  ENDDO
ENDDO
