...
DO JT = 1,5
  DO JP = 1,13
    ...
    DO IGC = 1,NGC(5)
      ...
      DO IPR = 1, NGN(NGS(4)+IGC)
        IPRSM = IPRSM + 1
        ZSUMK = ZSUMK + KA(IPRSM,JT,JP)*RWGT(IPRSM+64)
      ENDDO
      KAC(IGC,JT,JP) = ZSUMK
    ENDDO
  ENDDO
  ...
  DO JP = 13,59
    ...
    DO IGC = 1,NGC(5)
      ...
      DO IPR = 1, NGN(NGS(4)+IGC)
        IPRSM = IPRSM + 1
        ZSUMK = ZSUMK + KB(IPRSM,JT,JP)*RWGT(IPRSM+64)
      ENDDO
      KBC(IGC,JT,JP) = ZSUMK
    ENDDO
  ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(5)
    ...
    DO IPR = 1, NGN(NGS(4)+IGC)
      IPRSM = IPRSM + 1
      ZSUMK = ZSUMK + SELFREF(IPRSM,JT)*RWGT(IPRSM+64)
    ENDDO
...
DO JT = 1,4
  ...
  DO IGC = 1,NGC(5)
    ...
    DO IPR = 1, NGN(NGS(4)+IGC)
      IPRSM = IPRSM + 1
      ZSUMK = ZSUMK + FORREF(IPRSM,JT)*RWGT(IPRSM+64)
    ENDDO
