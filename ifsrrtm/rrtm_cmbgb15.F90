    ...
    DO JP = 1,13
      ...
      DO IGC = 1,NGC(15)
        ...
        DO IPR = 1, NGN(NGS(14)+IGC)
          ...
          Z_SUMK = Z_SUMK + KAO(IPRSM,JN,JT,JP)*RWGT(IPRSM+224)
        ENDDO
   ...
   DO JT = 1,19
      ...
      DO IGC = 1,NGC(15)
        Z_SUMK = 0.0_JPRB
         DO IPR = 1, NGN(NGS(14)+IGC)
            IPRSM = IPRSM + 1
            Z_SUMK = Z_SUMK + KAO_MN2(IPRSM,JN,JT)*RWGT(IPRSM+224)
         ENDDO
         KA_MN2(IGC,JN,JT) = Z_SUMK
      ENDDO
   ENDDO
ENDDO
...
DO JT = 1,10
  ...
  DO IGC = 1,NGC(15)
    ...
    DO IPR = 1, NGN(NGS(14)+IGC)
      ...
      Z_SUMK = Z_SUMK + SELFREFO(IPRSM,JT)*RWGT(IPRSM+224)
    ENDDO
...
DO JT = 1,4
   ...
   DO IGC = 1,NGC(15)
      ...
      DO IPR = 1, NGN(NGS(14)+IGC)
         IPRSM = IPRSM + 1
         Z_SUMK = Z_SUMK + FORREFO(IPRSM,JT)*RWGT(IPRSM+224)
      ENDDO
