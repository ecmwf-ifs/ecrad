!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL9(YDDIMV,KIDIA,KFDIA,KLEV,P_TAU,&
...
REAL(KIND=JPRB)   ,INTENT(IN)   :: PRAT_H2OCH4(KIDIA:KFDIA,YDDIMV%NFLEVG)
REAL(KIND=JPRB)   ,INTENT(IN)   :: PRAT_H2OCH4_1(KIDIA:KFDIA,YDDIMV%NFLEVG)
...
REAL(KIND=JPRB) :: Z_SPECCOMB(YDDIMV%NFLEVG),Z_SPECCOMB1(YDDIMV%NFLEVG),Z_SPECCOMB_MN2O(YDDIMV%NFLEVG),&
& Z_SPECCOMB_PLANCK(YDDIMV%NFLEVG)
...
REAL(KIND=JPRB) :: ZADJFAC,ZADJCOLN2O(KIDIA:KFDIA,YDDIMV%NFLEVG),ZRATN2O,ZCHI_N2O
