...
!-- DS_000515
         ...
         ZABSCO2 =  (KA_MCO2(IG,INDM(JLAY)) + PMINORFRAC(JLON,JLAY) * &
           &      (KA_MCO2(IG,INDM(JLAY)+1) - KA_MCO2(IG,INDM(JLAY))))
         ZABSO3 =  (KA_MO3(IG,INDM(JLAY)) + PMINORFRAC(JLON,JLAY) * &
           &      (KA_MO3(IG,INDM(JLAY)+1) - KA_MO3(IG,INDM(JLAY))))
         ZABSN2O =  (KA_MN2O(IG,INDM(JLAY)) + PMINORFRAC(JLON,JLAY) * &
           &      (KA_MN2O(IG,INDM(JLAY)+1) - KA_MN2O(IG,INDM(JLAY))))

        P_TAU(NGS7+IG,JLON,JLAY) = P_COLH2O(JLON,JLAY) *&
        ...
        PFRAC(NGS7+IG,JLON,JLAY) = FRACREFA(IG)
      ENDDO
    ENDIF
...
!-- JJM_000517
        ...
        P_TAU(NGS7+IG,JLON,JLAY) = P_COLO3(JLON,JLAY) *&
         ...
         & + P_WX(JLON,4,JLAY) * CFC22ADJ(IG)&
         & + P_TAUAERL(JLON,JLAY,8)  
        PFRAC(NGS7+IG,JLON,JLAY) = FRACREFB(IG)
      ENDDO
    ENDIF
  ENDDO
ENDDO
