...
REAL(KIND=JPRB) ,INTENT(INOUT) :: POD(KIDIA:KFDIA,KLEV,JPGPT)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PSSA(KIDIA:KFDIA,KLEV,JPGPT)
REAL(KIND=JPRB) ,INTENT(INOUT) :: PINCSOL(KIDIA:KFDIA,JPGPT)
